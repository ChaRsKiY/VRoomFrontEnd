...
import VideoPlayer from '../../watch/player';
import { BiArrowFromTop, BiCircle, BiPen, BiPencil, BiPlus, BiPlusCircle, BiSolidKeyboard, BiTrash, BiX } from 'react-icons/bi';
import '@/styes/modalsubtitles.css';
import handler from '@/services/upload';
import * as Accordion from '@radix-ui/react-accordion';
import { ISubtitle } from '@/types/subtitle.interface';
                ...
                <div style={{ width: "100%", backgroundColor: '#424242 ', color: "white" }}>
                                    ...
                                    >
                                        ...
                                        >
                                            <BiPlus
                                                ...
                                                // style={{
                                                //     boxShadow:
                                                //         'rgba(0, 0, 0, 0.6) 0px 10px 10px, rgba(0, 0, 0, 0.8) 0px 6px 6px',
                                                // }}
                                            />
                                        </Accordion.Trigger>
                                        <Accordion.Content
                                            className="p-4"
                                           // style={{ display: 'none' }} // Прячем контент, чтобы был виден только "плюсик"
                    ...
                    <div style={{ display: 'flex', justifyContent: 'space-between' }}>
                        ...
                        {!isChoosen ? (<>
                            ...
                            <div >
                                <button onClick={addForm} style={{
                                    margin: '20px', marginBottom: '12px', marginTop: '12px',
                                    boxShadow: 'rgba(0, 0, 0, 0.6) 0px 10px 20px, rgba(0, 0, 0, 0.8) 0px 6px 6px'
                                }}
                                    className='modal-button'>
                                    + Add</button>
