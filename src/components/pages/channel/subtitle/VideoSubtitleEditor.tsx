                            ...
                            <div>
                                {isChoosen && (<>
                                    ...
                                    <button className='publish-button'
                                            onClick={validateSubtitles}>Publish
                                    </button>
                                ...
                                <button className='modal-button ' onClick={() => {
                                    setDraftsDiaolg(true)
                                }}
                                        title='Exit'>
                                    <BiPlus style={{transform: 'rotate(45deg)'}}/>
                                </button>
                                <MDialog isOpen={draftsDialog} onClose={onClose} onAcsept={SaveDrafts}
                                         toDo="Save to draft"/>
                                {!isValid2 && (
                                    <div style={{
                                        ...
                                        <div>
                                            ...
                                            <div className='flex' style={{justifyContent: 'space-around'}}>
                                                ...
                                                <button className='modal-button ' onClick={PublishSubtitle}>Publish
                                                    subtitles
                                                </button>
                                            </div>
                                        </div>
