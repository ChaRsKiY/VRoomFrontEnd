...
export default function VideoUploadInterface() {
        ...
        <TabsContent value="details" className="space-y-4">
          <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
            <div className="md:col-span-2 space-y-4">
              <Input placeholder="11 Sep, 2024 - Baldur's Gate 3" />
...
If you're seeing this, comment "potato"

If you're interested in more valuable content, consider joining my free newsletter where I'll send you tips on leveling up your skills, exceptional social skills, and insights into human nature.
Click here to join:`}
              />
            </div>
            <div className="space-y-4">
              ...
              <Input placeholder="Video link" defaultValue="https://vroon.tv/NuTnm2U7yYo" />
              <div className="space-y-2">
