          ...
          <div style={{ marginBottom: '100px', width: '100%' }}  >
            ...
            <div className='content' style={{ width: '100%' }}>
              ...
              <button onClick={showMain} style={{
                padding: '5px', fontWeight: font1,
                marginLeft: '20px', margin: '2px', fontSize: "16px", borderBottom: border1, marginBottom: '0'
              }}>Main
              </button>
              <button onClick={showAll} style={{
                padding: '5px', fontWeight: font2,
                marginLeft: '20px', margin: '2px', fontSize: "16px", borderBottom: border2, marginBottom: '0'
              }}>Video</button>
              <button onClick={showLives} style={{
                padding: '5px', fontWeight: font5,
                marginLeft: '20px', margin: '2px', fontSize: "16px", borderBottom: border5, marginBottom: '0'
              }}>Lives</button>
              {isFolowed ? (
                <button onClick={showPosts} style={{
                  padding: '5px', fontWeight: font3,
                  marginLeft: '20px', margin: '2px', fontSize: "16px", borderBottom: border3, marginBottom: '0'
                }}>Posts</button>) : <></>}
              <button onClick={showPlaylists} style={{
                padding: '5px', fontWeight: font6,
                marginLeft: '20px', margin: '2px', fontSize: "16px", borderBottom: border6, marginBottom: '0'
              }}>Playlists</button>
              <button onClick={showAbout} style={{
                padding: '5px', fontWeight: font4,
                marginLeft: '20px', margin: '2px', fontSize: "16px", borderBottom: border4, marginBottom: '0'
              }}>About</button>
              <hr />
                      ...
                      <div style={{ display: 'flex', flexDirection: 'column' }}>
                        ...
                        <div style={{ display: 'flex', justifyContent: 'center' }}>
                          <Link href={el.channel_URL} style={{
                            padding: '2px', backgroundColor: 'lightgray',
                            paddingLeft: '10px', paddingRight: '10px', borderRadius: '5px', marginTop: '5px'
                          }}>Follow</Link>
                        </div>
                      </div>
                    </div>
