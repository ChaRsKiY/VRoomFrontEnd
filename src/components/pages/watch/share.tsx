...
import { FaFacebook, FaTwitter, FaTelegram, FaWhatsapp } from 'react-icons/fa'; // Иконки соцсетей
                ...
                style={{maxWidth:'410px'}}>
                    ...
                    <div className="flex space-x-4 justify-center">
                        ...
                        <a href={hrefFB} target="_blank" rel="noopener noreferrer">
                            <FaFacebook size={44} className="text-blue-600 cursor-pointer" title='Share on Facebook'/>
                        </a>
                        ...
                        <a href={hrefT} target="_blank" rel="noopener noreferrer">
                            <FaTelegram size={44} className="text-blue-500 cursor-pointer" title='Share on Telegram'/>
                        </a>
                        <a href={hrefW} target="_blank" rel="noopener noreferrer">
                            <FaWhatsapp size={44} className="text-green-500 cursor-pointer" title='Share on Whatsapp' />
                        </a> </div>
                        <br/>
