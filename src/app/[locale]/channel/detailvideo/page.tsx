...
//   const [userChannel, setUserChannel] = useState<IUser | null>();
//   const user = useUser();
...
//     if (user) {
//       const response = await api.get('/ChannelSettings/getinfochannel/' + user.user?.id);
...
//       if (response.status != 200) throw new Error('Failed to upload video data');
